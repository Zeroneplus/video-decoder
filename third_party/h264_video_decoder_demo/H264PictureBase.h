...
{
public:
    int32_t         mb_x; //�洢��ǰ���ڽ���ĺ���X���꣨�����ͼƬ���Ͻ�λ�ã�
    int32_t         mb_y; //�洢��ǰ���ڽ���ĺ���Y���꣨�����ͼƬ���Ͻ�λ�ã�
    int32_t         m_pic_coded_width_pixels; //ͼƬ������λ�����أ������磺1920x1088
    int32_t         m_pic_coded_height_pixels; //ͼƬ�ߣ���λ�����أ������磺1920x1088
    int32_t         PicWidthInMbs; //ͼƬ������λ��16x16�ĺ�飩
    int32_t         PicHeightInMbs; //ͼƬ�ߣ���λ��16x16�ĺ�飩
    int32_t         PicSizeInMbs; //PicSizeInMbs = PicWidthInMbs * PicHeightInMbs;
    int32_t         MbWidthL; //���Ⱥ��Ŀ�����λ�����أ�
    int32_t         MbHeightL; //���Ⱥ��Ŀ�����λ�����أ�
    int32_t         MbWidthC; //ɫ�Ⱥ��Ŀ�����λ�����أ�
    int32_t         MbHeightC; //ɫ�Ⱥ��Ŀ�����λ�����أ�
    int32_t         PicWidthInSamplesL; //PicWidthInSamplesL = PicWidthInMbs * 16; //�����ͼƬ�Ŀ��ȣ���λ�����أ�
    int32_t         PicWidthInSamplesC; //PicWidthInSamplesC = PicWidthInMbs * MbWidthC;
    int32_t         PicHeightInSamplesL; //PicHeightInSamplesL = PicHeightInMbs * 16; //�����ͼƬ�ĸ߶ȣ���λ�����أ�
    int32_t         PicHeightInSamplesC; //PicHeightInSamplesC = PicHeightInMbs * MbHeightC;
    int32_t         Chroma_Format; //CHROMA_FORMAT_IDC_420
    int32_t         mb_cnt; //����ĺ��ļ���
    int32_t         CurrMbAddr; //��ǰ����ĺ����ͼƬ�е�����λ��(���ֶηǳ���Ҫ)
    
    uint8_t *       m_pic_buff_luma; //�洢�����ͼƬ��Y�������� cSL[1920x1088]
    uint8_t *       m_pic_buff_cb; //�洢�����ͼƬ��cb��������
    uint8_t *       m_pic_buff_cr; //�洢�����ͼƬ��cr��������
    ...
    int32_t         PicOrderCnt;
    int32_t         FrameNum; //To each short-term reference picture ���ڲο�֡
    int32_t         FrameNumWrap; //To each short-term reference picture ���ڲο�֡
    int32_t         LongTermFrameIdx; //Each long-term reference picture ���ڲο�֡
    ...
    int32_t         memory_management_control_operation_5_flag; //���вο�ͼ����Ϊ�������ڲο���
    ...
    CH264SliceData      m_h264_slice_data; //ע�⣺һ��picture�п����ж��slice data
    CH264MacroBlock *   m_mbs; //�洢��ǰͼ������к�� m_mbs[PicSizeInMbs] = m_mbs[PicWidthInMbs * PicHeightInMbs];
    ...
    int32_t                    m_is_malloc_mem_by_myself; //�Ƿ��Ѿ���ʼ��
    int32_t                    m_is_decode_finished; //��֡/���Ƿ�������
    int32_t                    m_slice_cnt; //һ��picture�п����ж��slice data
    ...
    int32_t             m_RefPicList0Length; //RefPicList0�����Ĳο�ͼ����Ŀ
    int32_t             m_RefPicList1Length; //RefPicList1�����Ĳο�ͼ����Ŀ
    int32_t             m_PicNumCnt; //ͼƬ��������
...
public:
    ...
    int unInit();
    CH264PictureBase & operator = (const CH264PictureBase &src); //���صȺ������
    ...
    //-------------------------------------
    int convertYuv420pToBgr24(uint32_t width, uint32_t height, const uint8_t *yuv420p, uint8_t *bgr24, uint32_t widthBytesBgr24); //ͼ�������·�ת�ģ���Ҫ���ڱ����BMPͼƬ
    int convertYuv420pToBgr24FlipLines(uint32_t width, uint32_t height, const uint8_t *yuv420p, uint8_t *bgr24, uint32_t widthBytesBgr24); //ͼ�������·�ת�ģ���Ҫ���ڲ�������ͼ
    int createEmptyImage(MY_BITMAP &bitmap, int32_t width, int32_t height, int32_t bmBitsPixel); //���ڴ��д���һ���հ�λͼ
    ...
    int Decoding_process_for_reference_picture_lists_construction(CH264Picture *(&dpb)[16], CH264Picture *(&RefPicList0)[16], CH264Picture *(&RefPicList1)[16]); //8.2.4 �ο�ͼ���б������������
    ...
    int Modification_process_for_reference_picture_lists(CH264Picture *(&RefPicList0)[16], CH264Picture *(&RefPicList1)[16]); //8.2.4.3 �ο�ͼ���б������������
    ...
    int Decoded_reference_picture_marking_process(CH264Picture *(&dpb)[16]); //8.2.5 ÿһ��ͼƬ������ɺ󣬶���Ҫ���һ��ͼ��ο��б�
    ...
    int PicOrderCntFunc(CH264PictureBase *picX); //8.2.1 POC: picture order count ͼ�����к�
