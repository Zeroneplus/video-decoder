...
int CFileReader::getNextH264NalUnitByStartCode(unsigned char *&data, int &size)
{
    ...
    //ȷ��m_buffer_pointer_pos[0..3]һ����00 00 00 01��ʼ��
    while(1)
    {
        ...
        if (ret == 2) //��m_buffer_pointer_pos[0..end]�У��������ҵ���������������ʼ�룬��������ң���m_buffer_start[]��������ܹ����ɳߴ�����I֡��
        {
        ...
        else if (ret == 1) //��m_buffer_pointer_pos[0..end]�У�������ֻ�ҵ��˵�һ����ʼ��
        {
            // ��00 00 00 01��ʼ���Լ�֮������ݣ���ǰ�ƶ���������m_buffer_start[0]����
            if (pos1 > m_buffer_pointer_pos)
            {
                //���� memmove(m_buffer_start, pos1, m_buffer_end - (pos1 - m_buffer_start) + 1);
            ...
            if (left_bytes > 0)
            {
                size_t readBytes = fread(m_buffer_end + 1, 1, left_bytes, m_fp); //���ļ��ж�ȡ����
                if (readBytes <= 0) //˵���Ѿ������ļ�ĩβ��
                {
        ...
        else //��m_buffer_start[0..end]�У�������δ�ҵ�һ����ʼ��
        {
            m_buffer_end = m_buffer_start;
